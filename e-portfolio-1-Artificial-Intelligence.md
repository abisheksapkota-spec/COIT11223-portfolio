...
This has altered my previous conception of AI, which I regarded as merely a tool for acquiring knowledge and increasing efficiency, but this also indicates the potential of AI as a source of ethical and regulatory difficulties. This directly reflects the Week 2 workshop discussion on accountability, privacy, and governance, where we debated who should be held responsible when an AI system produces a harmful or incorrect outcome. Assessing the role of AI in helping the user was easy, while the interpretation of who is responsible in the case of AI providing wrong or dangerous information remained difficult. Having reflected on the workshop discussion further, I now lean towards the view that accountability should sit with the developers and organisations deploying the system rather than the end user, since it is their design and testing decisions that shape how the AI behaves.
...
|---|---|
| **Workshop** | Week 2 |
| **Day / Date** | Thursday, 23 July 2026 |
...
<img width="480" height="640" alt="WorkshopsLab" src="https://github.com/user-attachments/assets/b0481a8b-0a44-4098-b9b9-354124ad5183" />
